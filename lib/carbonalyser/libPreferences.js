        ...
        if ( prefText !== undefined ) {
            ...
            preferences = {
                ...
                tab: {
                    ...
                    min_attention_time: {value: (3 * 1000), description: "threshold for attention time do not show anything below that (in ms)"}
                },
                popup: {
                    update: {
                        auto_refresh: {value: true, description: "auto refresh"},
...
window.addEventListener("load", LP_init);
window.addEventListener("unload", LP_end);