    ...
    if ( preferences === null || preferences === undefined ) {
        ...
        if ( prefText !== undefined ) {
            ...
            preferences = {
                daemon: {
                    storage: {
                        flushingIntervalMs: 5000,      // interval (ms) at which we write the storage
                        restartCheckerMsLatency: 100,  // latency that apply when preferences have been changed
                    },
                    downloads: {
                        latencyBetweenChecksMs: 1000    // interval at which we check for download end (ms).
                    }
                },
                analysis: {
                ...
                general: {
                    update: {
                        storageFetchMs:   1000   // latency induced for storage fetch by guis (ms)
                    }
                },
