...
const translateText = (target, translationKey) => {
    target.appendChild(document.createTextNode(translate(translationKey)));
}

const translateHref = (target, translationKey) => {
 ...
 * @param {*} o 
 */
const attachParent = (o) => {
	attachParentRecurse(null, o);
}

const attachPoint = "parent";

const attachParentRecurse = (parent, o) => {
